          ...
          <div className="animate-in fade-in duration-300">
            ...
            <div className="mb-8 bg-white border border-slate-200 rounded-xl p-6">
              ...
              <p className="text-slate-500 mb-4 text-sm">
                Tell us what kind of forms you need, and our AI will generate
            ...
            {templates.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {templates.map((template, idx) => (
                  <div
                    key={idx}
                    className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-md transition-shadow flex flex-col"
                  >
              ...
              <div className="bg-white border border-slate-200 border-dashed rounded-2xl p-12 text-center">
                ...
                <p className="text-slate-500 max-w-sm mx-auto">
                  Enter a topic above to generate AI-powered form templates
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled
                    value={user?.uid || ""}
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-500 text-sm font-mono"
                  />
                </div>
              </div>
            </div>
